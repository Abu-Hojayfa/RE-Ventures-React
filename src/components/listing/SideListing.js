    ...
    return (
        <div className="space-y-7 mt-8">
            ...
            {data.map((property, index) => (
                <div
                    key={index}
                    className="bg-base-100 hover:shadow-xl relative border border-[gray-400] rounded-2xl overflow-hidden cursor-pointer transition-all duration-700 grid grid-cols-12"
                >
                    {/* Status Badge */}
                    <div
