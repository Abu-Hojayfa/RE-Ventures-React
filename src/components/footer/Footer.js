...
import footerlogo from '../../assests/logos/image.png';
        ...
        <div className=' bg-[#161E2D] text-white '>
            <div className='w-5/6 mx-auto '>
                ...
                <footer className="footer flex items-center justify-between p-10">
                    <div>
                        <p className='w-5/6 m-0 p-0 text-[#546075] text-base'>Specializes in providing high-class tours for those in need. Contact Us to get Best Value</p>
                ...
                <footer className="footer border-base-300 border-t px-10 pl-5 py-4">
